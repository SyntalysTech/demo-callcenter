...
const mainNavItems = [
  ...
  { href: '/calid-ai', label: 'Asistente IA', icon: Sparkles },
...
const callCenterItems = [
  { href: '/call-center/prueba', label: 'Agente de Voz', icon: PhoneCall, active: true },
          ...
          <div className={`flex items-center gap-2 transition-all duration-300 ${
            ...
            {!collapsed && (
              <div className="flex flex-col">
                <span className="text-white font-bold text-lg leading-tight">EnergyVoice</span>
                <span className="text-white/60 text-xs">AI Demo</span>
              </div>
            )}
          </div>
        </Link>
