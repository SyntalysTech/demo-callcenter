...
// Estados del CRM - Adaptados para demo de empresas energéticas
export const STATUS_CONFIG: Record<LeadStatus, { label: string; shortLabel: string; color: string; bgColor: string; description: string }> = {
  red: {
    label: 'No interesado',
    shortLabel: 'No interesado',
    color: 'text-white',
    bgColor: 'bg-red-500',
    description: 'El cliente no está interesado o no es viable',
  },
  yellow: {
    label: 'No contesta',
    shortLabel: 'No contesta',
    color: 'text-black',
    bgColor: 'bg-yellow-400',
    description: 'Sin respuesta - pendiente de contactar',
  },
  orange: {
    label: 'Llamar luego',
    shortLabel: 'Llamar luego',
    color: 'text-white',
    bgColor: 'bg-orange-500',
    description: 'Interesado pero solicita llamar más tarde',
  },
  blue: {
    ...
    color: 'text-white',
    bgColor: 'bg-blue-500',
    description: 'Cita o llamada programada para fecha específica',
  },
  green: {
    label: 'Interesado / Cerrado',
    shortLabel: 'Interesado',
    color: 'text-white',
    bgColor: 'bg-green-500',
    description: 'Cliente interesado o contrato cerrado',
  },
};
